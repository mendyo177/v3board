...
class ConfigController extends Controller
{
    ...
    public function testSendMail(Request $request)
    {
        $obj = new SendEmailJob([
            ...
            'subject' => 'This is v3board test email',
            'template_name' => 'notify',
            'template_value' => [
                'name' => config('v2board.app_name', 'V3Board'),
                'content' => 'This is v3board test email',
    ...
    public function fetch(Request $request)
    {
        ...
        $data = [
            ...
            'site' => [
                ...
                'app_name' => config('v2board.app_name', 'V3Board'),
                'app_description' => config('v2board.app_description', 'V3Board is best!'),
